...
},getAdInfo:function(e,a,d,c){var b=this.controller.callLayerFunction("freewheel","getAdInfo",[e.getCustomId(),a,d,c]);
return b
...
}}},mediaPlaying:function(e){if(this._active){var a=e.currentTime;
var c=e.duration;
...
var a=false;
var h,c,g;
try{h=this._controller.getVideoProxy();
c=h.currentTime;
g=h.duration
}catch(f){a=true
}if((a||c!==g)&&!this._paused&&this._pauseSetCallback&&this._active){this._paused=true;
